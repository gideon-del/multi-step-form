...
function App() {
  ...
  return (
    <>
      <main className="font-Medium  md:px-2 md:py-2 m-auto flex flex-col md:flex-row  relative bg-white rounded-lg inset-0 max-w-5xl flex-1 min-h-screen md:min-h-none  ">
        <Steps />
